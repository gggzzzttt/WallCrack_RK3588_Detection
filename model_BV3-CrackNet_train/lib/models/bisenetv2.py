...
class BiSeNetV2(nn.Module):
    ...
    def __init__(self, n_classes, aux_mode='train', load_pretrain_backbone=True):
        super(BiSeNetV2, self).__init__()
        self.aux_mode = aux_mode
        self.load_pretrain_backbone = load_pretrain_backbone
    ...
    def load_pretrain(self):
        return
        # 下面原有下载代码全部注释
        # if not self.load_pretrain_backbone:
        #     return
